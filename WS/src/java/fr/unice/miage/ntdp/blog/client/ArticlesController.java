...
import fr.unice.miage.ntdp.blog.bean.ArticlesFacade;
...
public class ArticlesController implements Serializable {
    ...
    @EJB
    private fr.unice.miage.ntdp.blog.bean.ArticlesFacade ejbFacade;
    ...
    public Articles getArticles(java.lang.Long id) {
