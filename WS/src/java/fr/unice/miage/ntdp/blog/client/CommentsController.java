...
import fr.unice.miage.ntdp.blog.bean.CommentsFacade;
...
public class CommentsController implements Serializable {
    ...
    @EJB
    private fr.unice.miage.ntdp.blog.bean.CommentsFacade ejbFacade;
    ...
    public Comments getComments(java.lang.Long id) {
